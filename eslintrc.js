...
module.exports = {
	env: {
		node: true,
		mocha: true,
		es6: true, // we cannot use all of es6 features but some of them are already supported across browsers (like Map)
	},
	parserOptions: {
		sourceType: 'module',
		ecmaVersion: 2017,
	...
	rules: {
		...
		'class-methods-use-this': 'off',	        	//	enforce that class methods utilize this (switched off because web component classes are unnamed and thus cannot use static methods)
		...
		'dot-notation': 'off',					        //	auto fixable enforce dot notation whenever possible
		...
		'no-magic-numbers': ['off', { ignore: [0, 1, -1], ignoreArrayIndexes: true }],	//	disallow magic numbers
		'no-multi-spaces': ['error'],			        //	auto fixable disallow multiple spaces
		'no-multi-str': ['error'],				        //	disallow multi line strings
		...
		'no-use-before-define': ['error', {"functions": false}],		        //	disallow the use of variables before they are defined. Functions are ok.
		...
		'id-length': ['error', { min: 2, exceptions: ['i', 'j', 'x', 'y', '_', '$'] }],	//	enforce minimum and maximum identifier lengths
		...
		indent: ['error', 'tab', { VariableDeclarator: 0 }], //	auto fixable enforce consistent indentation
		'jsx-quotes': 'off',					        //	auto fixable enforce the consistent use of either double or single quotes in JSX attributes
		...
		'keyword-spacing': ['error', { before: true, after: true, overrides: { default: { after: false } } }],	//	auto fixable enforce consistent spacing before and after keywords
		...
		'lines-around-comment': 'off',			        //	auto fixable require empty lines around comments
		...
		'new-cap': ['error', { capIsNewExceptions: ['Polymer'] }],	//	require constructor function names to begin with a capital letter
		...
		'newline-before-return': 'off',	                //	auto fixable require an empty line before return statements
		...
		'no-trailing-spaces': ['off', { skipBlankLines: false }],	//	auto fixable disallow trailing whitespace at the end of lines
		'no-underscore-dangle': 'off',			        //	disallow dangling underscores in identifiers
		'no-unneeded-ternary': ['error'],		        //	disallow ternary operators when simpler alternatives exist
		'no-whitespace-before-property': ['error'],	    //	auto fixable disallow whitespace before properties
		'object-curly-newline': 'off',	                //	auto fixable enforce consistent line breaks inside braces
		...
		quotes: ['error', 'single', { avoidEscape: true }],	//	auto fixable enforce the consistent use of either back ticks, double, or single quotes
		...
		'space-before-function-paren': ['error', 'never'],	//	auto fixable enforce consistent spacing before function definition opening parenthesis
		...
		'spaced-comment': 'off',	        			//	auto fixable enforce consistent spacing after the // or /* in a comment
		...
		'prefer-arrow-callback': ['error', { allowNamedFunctions: true }],			        //	auto fixable require arrow functions as callbacks
